        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-dark text-light d-flex justify-content-between">
                    ...
                    <a href="lista_productos.php" class="btn btn-success">Lista de productos</a>
                </div>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <?php
                            if (isset($_POST['btn_search'])) {
                                $sql = "SELECT * FROM catalogo WHERE id_producto='".$_POST['txtDato']."' OR nombre_producto LIKE '%".$_POST['txtDato']."%'";

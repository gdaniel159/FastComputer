...
<div class="container">
    <?php
        ...
        if (isset($_POST['btn_send'])) {
            ...
            $sql = "SELECT max(id_producto) FROM catalogo";
            ...
            $foto = 'resource/'.$id.'.jpg';

            $sql = "INSERT INTO catalogo(id_producto,nombre_producto,descripcion,precio,imagen) VALUES('$id','$name','$desc','$precio','$foto')";

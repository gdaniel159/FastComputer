...
<?php
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM mas_vendidos WHERE id_producto='".$id."'";
    ...
    <div class="row d-flex justify-content-center align-items-center" style="height:79.9vh">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="actualizar_producto_masvendido.php" method="POST" name="frmContacInformation">
                        <div class="form-group d-flex justify-content-end">
                            <a href="productos_mas_vendidos.php" class="btn btn-primary">Ver datos</a>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" name="desc" class="form-control" placeholder="Ingrese la descripcion del producto" required value="<?php echo $desc;?>">
                        </div>
                        <div class="form-group">
